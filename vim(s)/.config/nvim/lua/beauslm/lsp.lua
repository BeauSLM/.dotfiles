...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<silent>gd', '<Cmd>lua vim.lsp.buf.definition()<CR>', opts)
  ...
  -- buf_set_keymap('n', '<leader>ca', '<cmd>lua vim.lsp.buf.range_code_action()<CR>', opts)
